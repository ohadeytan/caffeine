 ...
 */
package com.github.benmanes.caffeine.cache.simulator.parser.msr;
...
/**
 */
public final class MsrTraceReader extends TextTraceReader {

  static final int BLOCK_SIZE = 4096;

  public MsrTraceReader(List<String> filePaths) {
    super(filePaths);
  }
