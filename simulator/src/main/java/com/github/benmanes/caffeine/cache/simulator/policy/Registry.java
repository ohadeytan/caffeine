...
public final class Registry {
  ...
  private static void registerSketch(Map<String, Function<Config, Set<Policy>>> factories) {
    ...
    factories.put("sketch.SizedSampledTinyLfu", SizedSampledTinyLfuPolicy::policies);
    factories.put("sketch.SumSizedSampledTinyLfu", SumSizedSampledTinyLfuPolicy::policies);
    factories.put("sketch.RistrettoSizedSampledTinyLfu", RistrettoSizedSampledTinyLfuPolicy::policies);
